-- Insert payment method feature flags by temporarily bypassing RLS
-- This ensures the feature flags are actually inserted into the database

-- Temporarily disable RLS for this operation
ALTER TABLE platform_feature_flags DISABLE ROW LEVEL SECURITY;

-- Insert all payment method feature flags
...
BEGIN
  ...
  RAISE NOTICE 'Payment method feature flags successfully inserted: % records found', 
