-- Update RLS policies for public-assets bucket to enforce tenant membership
...
-- Allow authenticated users to upload assets to their tenant folder if they are a member/admin
CREATE POLICY "Tenant member can upload own assets"
...
CREATE POLICY "Tenant member can update own assets"
...
CREATE POLICY "Tenant member can delete own assets"
