        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
          <Card className="group text-center hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-400 hover:scale-105">
            <CardContent className="pt-8 pb-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">{tIntegrations('payment.title')}</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{tIntegrations('payment.description')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="group text-center hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-400 hover:scale-105">
            <CardContent className="pt-8 pb-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">{tIntegrations('analytics.title')}</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{tIntegrations('analytics.description')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="group text-center hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-400 hover:scale-105">
            <CardContent className="pt-8 pb-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">{tIntegrations('social.title')}</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{tIntegrations('social.description')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="group text-center hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-400 hover:scale-105">
            <CardContent className="pt-8 pb-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">{tIntegrations('email.title')}</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{tIntegrations('email.description')}</p>
            </CardContent>
          </Card>
        </div>

        <div className="text-center bg-white/50 backdrop-blur-sm rounded-2xl py-8 px-6 max-w-3xl mx-auto border border-purple-200">
          <p className="text-gray-700 mb-6 text-lg font-medium">{tIntegrations('moreIntegrations')}</p>
